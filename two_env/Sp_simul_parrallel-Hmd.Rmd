...
Symmetric_Gaussian_function <- source("Symmetric_Gaussian_function.R")
AsymetricGaussian_functions <- source("AsymetricGaussian_functions.R")
...
result_df <- foreach(iteration = 1:n.reps, .packages=c("pacman", "ade4"), .export =
                       c("AllNicheBreadthFunctions_Hmd", "Symmetric_Gaussian_function",
  ...
  source("Symmetric_Gaussian_function.R")
...
result_df_asy_uniform <- result_df_asy
...
df_uniform <- Sym_mean_correlation_results %>% 
  inner_join(asy_mean_correlation_results, by = "metric")

#write.csv(df_uniform, file = "df_uniform_15Sept.csv")
...
#save.image("uniform_model_result_Sept15.RData")
