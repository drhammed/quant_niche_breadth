...
ggplot(result_df_asy_long, aes(x = factor(iteration), y = metrics_scaled, color = Metrics)) +
  ...
  labs(x = "Iterations", y = "Estimated Niche Breadth", title = "Normal Niche Breadth across Iterations-Asymmetric") +
  theme_minimal() +
  scale_y_continuous(limits = c(0, 1))
...
#Export the result
write.csv(asy_anova_mean_results, "normal_asy_anova_mean_results.csv")
