---
title: "sp_simu_normal_single_parallel"
...
normal_Symmetric_Gaussian_function <- source("Single_Sym_Gau_normal_NB_function.R")
normal_AsymetricGaussian_functions <- source("Single_Asy_Gau_normal_NB_function.R")
...
result_df <- foreach(iteration = 1:n.reps, .packages=c("pacman", "ade4"), .export =
  ...
  source("Single_Sym_Gau_normal_NB_function.R")
  source("Single_Asy_Gau_normal_NB_function.R")
  ...
  SimpSSI <- co_occur(GOSmat, reps = 100, psample = 3, psample2 = 2)$multi.sim
  beta.a <- co_occur(GOSmat, reps = 100, psample = 3, psample2 = 2)$Beta.a
  beta.w <- co_occur(GOSmat, reps = 100, psample = 3, psample2 = 2)$Beta.w
  omi_result <- omi_params_fun(env_vars = env_vars, PA = sim.com)
...
result_df_asy <- foreach(iteration = 1:n.reps, .packages=c("pacman", "ade4"), 
  ...
  # Load required packages
  pacman::p_load(data.table,ade4,tidyverse,cubelyr,tmap,mapview,exactextractr,lubridate,prism,e1071,
                 ade4, vegan,dplyr,reshape2,ggpmisc,ggplot2,e1071,corrplot,nicheROVER,hypervolume,
                 ggpubr, mFD,ecoCopula)
...
#save.image("single_normal_model_result_Sept19.RData")

#load("single_normal_model_result_Jan14.RData")
