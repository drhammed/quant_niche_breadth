...
Symmetric_Gaussian_function <- source("Single_Sym_Gau_uniform_Function.R")
AsymetricGaussian_functions <- source("Single_Asy_Gau_uniform_Function.R")
...
result_df <- foreach(iteration = 1:n.reps, .packages=c("pacman", "ade4"), .export = c("AllNicheBreadthFunctions_Hmd", "Symmetric_Gaussian_function", "AsymetricGaussian_functions", "DavidZelenyThetaFunctions")) %dopar% {
  ...
  # Load custom functions
   ...
   source("Single_Sym_Gau_uniform_Function.R")
   source("Single_Asy_Gau_uniform_Function.R")
...
#save.image("single_uniform_model_result_Jan13.RData")

#save.image("single_uniform_model_result_17Sept.RData")
